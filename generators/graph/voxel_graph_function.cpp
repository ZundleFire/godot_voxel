...
void VoxelGraphFunction::_bind_methods() {
	...
	BIND_ENUM_CONSTANT(NODE_OUTPUT_TYPE);
	BIND_ENUM_CONSTANT(NODE_OUTPUT_SINGLE_TEXTURE);
	BIND_ENUM_CONSTANT(NODE_OUTPUT_MATERIAL);
	BIND_ENUM_CONSTANT(NODE_HEIGHT_SPLITTER);
	BIND_ENUM_CONSTANT(NODE_SLOPE_MASK);
	BIND_ENUM_CONSTANT(NODE_ALTITUDE_MASK);
	BIND_ENUM_CONSTANT(NODE_NOISE_MASK);
	BIND_ENUM_CONSTANT(NODE_MATERIAL);
	BIND_ENUM_CONSTANT(NODE_BLEND_MATERIAL);
	BIND_ENUM_CONSTANT(NODE_MATERIAL_SWITCH);
	BIND_ENUM_CONSTANT(NODE_MATERIAL_PROPERTY_OVERRIDE);
	BIND_ENUM_CONSTANT(NODE_MATERIAL_STACK);
	BIND_ENUM_CONSTANT(NODE_MATERIAL_MIXER);
	...
	BIND_ENUM_CONSTANT(NODE_PLANET_ALTITUDE);
	BIND_ENUM_CONSTANT(NODE_PLANET_LATITUDE);
	BIND_ENUM_CONSTANT(NODE_PLANET_LONGITUDE);
	BIND_ENUM_CONSTANT(NODE_PLANET_CLIMATE);
	BIND_ENUM_CONSTANT(NODE_PLANET_BIOME);
	BIND_ENUM_CONSTANT(NODE_PLANET_CELL_NOISE);
	BIND_ENUM_CONSTANT(NODE_PLANET_TECTONICS);
	BIND_ENUM_CONSTANT(NODE_PROCEDURAL_NOISE_2D);
	BIND_ENUM_CONSTANT(NODE_PROCEDURAL_NOISE_3D);
	BIND_ENUM_CONSTANT(NODE_INFINITE_TERRAIN_2D);
	BIND_ENUM_CONSTANT(NODE_INFINITE_TERRAIN_3D);
	BIND_ENUM_CONSTANT(NODE_TERRAIN_CLIMATE_2D);
	BIND_ENUM_CONSTANT(NODE_TERRAIN_CLIMATE_3D);
	BIND_ENUM_CONSTANT(NODE_SPHERE_STAMP);
	BIND_ENUM_CONSTANT(NODE_TERRAIN_RIVERS_2D);
	BIND_ENUM_CONSTANT(NODE_TERRAIN_MATERIAL_BLEND);
	BIND_ENUM_CONSTANT(NODE_PLANET_EROSION);
