//
// modules\voxel\generators\graph\voxel_graph_math_ops_ispc_ispc_sse4.h
...
extern "C" {
#endif // __cplusplus
    extern void VoxelGraphMath_BinaryOp(const float * a_data, int32_t a_is_constant, float a_constant, const float * b_data, int32_t b_is_constant, float b_constant, float * out_data, int32_t op, int32_t count);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
